    ...
    <>
      ...
      >
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:w-1/2  mt-12 md:mt-28 space-y-2 order-2 md:order-1">
            ...
            <div className="flex flex-col space-x-2 items-center md:flex-row ">
              <Link to="Contact" smooth={true} duration={500} offset={-70}>
                <button
                  className="px-6 py-2 text-red-700 border-2 border-black rounded-lg shadow-md  hover:bg-gray-100 hover:scale-105 hover:shadow-lg active:scale-95 transition-all duration-300 ease-in-out"
                >
                  Hire Me
                </button>
              </Link>
          ...
          {/* right */}
          <div className="md:w-1/2 md:ml-48 mt-8 md:mt-10 order-1">
            <img
              src={img}
